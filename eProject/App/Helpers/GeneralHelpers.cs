...
namespace eProject.App.Helpers
{
    public static class GeneralHelpers
    {
        ...
        public static string ActiveMenuLink(this IHtmlHelper htmlHelper, string controllers, string actions, string cssClass = "active")
        {
        ...
        public static string ActiveMenuItem(this IHtmlHelper htmlHelper, string controllers, string actions, string cssClass = "menu-open")
        {
            string currentAction = htmlHelper.ViewContext.RouteData.Values["action"] as string;
            string currentController = htmlHelper.ViewContext.RouteData.Values["controller"] as string;
